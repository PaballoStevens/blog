      ...
      <div class="page-header-content">
          <div class="row align-items-center justify-content-between pt-3">
              ...
              <div class="col-12 col-xl-auto mb-3">
                  ...
                  <a href="/admin?a=edit&rid={{$article->slug}}" class="btn btn-sm btn-light text-primary" >
...
<div class="site-section py-0">
      ...
      <div class="site-section">
        ...
        <div class="img-bg" style="background-image:url(https://preview.colorlib.com/theme/meranda/images/xbig_img_1.jpg.pagespeed.ic.K2N7KNYATl.webp)"></div>
        <div class="contents">
        <span class="caption">Editor's Pick</span>
        <h2>{{$article->title}}</h2>
        <p class="mb-3">{!! $article->content !!}</p>
        <div class="post-meta">
        <span class="d-block"><a href="#">{{$article->name}}</a> in <a href="#">Food</a></span>
