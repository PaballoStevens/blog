                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="/admin/view/{{$item->slug}}"><i class="fa fa-eye"></i></a>
                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="/admin?a=edit&rid={{$item->slug}}"><i class="fa fa-pencil"></i></button>
                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="/admin/{{$item->slug}}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
